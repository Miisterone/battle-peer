...
export function Grid() {
    ...
    return (
        <div className="flex flex-col items-center mt-10 h-screen bg-gray-700">
            <h1 className="text-white font-bold mb-4">{isPlaying ? "Phase de jeu : Tire sur l'ennemi !" : "Place tes bateaux"}</h1>
            ...
            {!isPlaying && <button onClick={startGame} className="mt-4 p-2 bg-green-500 text-white rounded">Commencer la partie</button>}
        </div>
    );
}
